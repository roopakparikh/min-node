...
#define OPTION_MASK_ISA_CRC32 (HOST_WIDE_INT_1 << 23)
#define OPTION_MASK_ISA_CX16 (HOST_WIDE_INT_1 << 24)
#define OPTION_MASK_ISA_F16C (HOST_WIDE_INT_1 << 25)
#define MASK_NO_FANCY_MATH_387 (1 << 9)
#define OPTION_MASK_ISA_FMA (HOST_WIDE_INT_1 << 26)
#define OPTION_MASK_ISA_FMA4 (HOST_WIDE_INT_1 << 27)
#define MASK_FLOAT_RETURNS (1 << 10)
#define OPTION_MASK_ISA_FSGSBASE (HOST_WIDE_INT_1 << 28)
#define OPTION_MASK_ISA_FXSR (HOST_WIDE_INT_1 << 29)
#define OPTION_MASK_ISA_HLE (HOST_WIDE_INT_1 << 30)
...
#define OPTION_MASK_ISA_LWP (HOST_WIDE_INT_1 << 31)
#define OPTION_MASK_ISA_LZCNT (HOST_WIDE_INT_1 << 32)
#define OPTION_MASK_ISA_MMX (HOST_WIDE_INT_1 << 33)
#define OPTION_MASK_ISA_MOVBE (HOST_WIDE_INT_1 << 34)
#define OPTION_MASK_ISA_MPX (HOST_WIDE_INT_1 << 35)
#define MASK_MS_BITFIELD_LAYOUT (1 << 16)
#define OPTION_MASK_ISA_MWAITX (HOST_WIDE_INT_1 << 36)
#define MASK_NO_PUSH_ARGS (1 << 17)
#define MASK_NO_RED_ZONE (1 << 18)
#define OPTION_MASK_ISA_SSE4_1 (HOST_WIDE_INT_1 << 37)
#define MASK_OMIT_LEAF_FRAME_POINTER (1 << 19)
#define OPTION_MASK_ISA_PCLMUL (HOST_WIDE_INT_1 << 38)
#define OPTION_MASK_ISA_PCOMMIT (HOST_WIDE_INT_1 << 39)
#define OPTION_MASK_ISA_POPCNT (HOST_WIDE_INT_1 << 40)
#define MASK_PREFER_AVX128 (1 << 20)
#define OPTION_MASK_ISA_PREFETCHWT1 (HOST_WIDE_INT_1 << 41)
#define OPTION_MASK_ISA_PRFCHW (HOST_WIDE_INT_1 << 42)
#define OPTION_MASK_ISA_RDRND (HOST_WIDE_INT_1 << 43)
#define OPTION_MASK_ISA_RDSEED (HOST_WIDE_INT_1 << 44)
#define MASK_RECIP (1 << 21)
#define MASK_RTD (1 << 22)
#define OPTION_MASK_ISA_RTM (HOST_WIDE_INT_1 << 45)
#define OPTION_MASK_ISA_SAHF (HOST_WIDE_INT_1 << 46)
#define OPTION_MASK_ISA_SHA (HOST_WIDE_INT_1 << 47)
#define OPTION_MASK_ISA_SSE (HOST_WIDE_INT_1 << 48)
#define OPTION_MASK_ISA_SSE2 (HOST_WIDE_INT_1 << 49)
#define OPTION_MASK_ISA_SSE3 (HOST_WIDE_INT_1 << 50)
#define OPTION_MASK_ISA_SSE4_2 (HOST_WIDE_INT_1 << 51)
#define OPTION_MASK_ISA_SSE4A (HOST_WIDE_INT_1 << 52)
#define MASK_SSEREGPARM (1 << 23)
#define OPTION_MASK_ISA_SSSE3 (HOST_WIDE_INT_1 << 53)
#define MASK_STACK_PROBE (1 << 24)
#define OPTION_MASK_ISA_TBM (HOST_WIDE_INT_1 << 54)
#define MASK_TLS_DIRECT_SEG_REFS (1 << 25)
#define MASK_VECT8_RETURNS (1 << 26)
#define MASK_VZEROUPPER (1 << 27)
#define OPTION_MASK_ABI_X32 (HOST_WIDE_INT_1 << 55)
#define OPTION_MASK_ISA_XOP (HOST_WIDE_INT_1 << 56)
#define OPTION_MASK_ISA_XSAVE (HOST_WIDE_INT_1 << 57)
#define OPTION_MASK_ISA_XSAVEC (HOST_WIDE_INT_1 << 58)
#define OPTION_MASK_ISA_XSAVEOPT (HOST_WIDE_INT_1 << 59)
#define OPTION_MASK_ISA_XSAVES (HOST_WIDE_INT_1 << 60)
...
enum opt_code
{
  ...
  OPT_Wpoison_system_directories = 334,      /* -Wpoison-system-directories */
  OPT_Wpragmas = 335,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 336,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 337,                       /* -Wprotocol */
  OPT_Wpsabi = 338,                          /* -Wpsabi */
  OPT_Wraw = 339,                            /* -Wraw */
  OPT_Wreal_q_constant = 340,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 341,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 342,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 343,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 344,            /* -Wredundant-modifiers */
  OPT_Wreorder = 345,                        /* -Wreorder */
  OPT_Wreturn_local_addr = 346,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 347,                    /* -Wreturn-type */
  OPT_Wselector = 348,                       /* -Wselector */
  OPT_Wsequence_point = 349,                 /* -Wsequence-point */
  OPT_Wserial = 350,                         /* -Wserial */
  OPT_Wshadow = 351,                         /* -Wshadow */
  OPT_Wshadow_ivar = 352,                    /* -Wshadow-ivar */
  OPT_Wshift_count_negative = 353,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 354,           /* -Wshift-count-overflow */
  OPT_Wsign_compare = 355,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 356,                /* -Wsign-conversion */
  OPT_Wsign_promo = 357,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 358,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 359,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_memaccess = 360,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspecial_param_hiding = 361,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 362,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 363,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 364,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 365,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 366,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 367,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 368,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 369,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 370,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 371,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 372,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 373,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 374,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 375,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 376,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 377,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 378,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 379,               /* -Wsuggest-override */
  OPT_Wsuppress = 380,                       /* -Wsuppress */
  OPT_Wsurprising = 381,                     /* -Wsurprising */
  OPT_Wswitch = 382,                         /* -Wswitch */
  OPT_Wswitch_bool = 383,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 384,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 385,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 386,                      /* -Wsync-nand */
  OPT_Wsynth = 387,                          /* -Wsynth */
  OPT_Wsynthetic_access = 388,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 389,                 /* -Wsystem-headers */
  OPT_Wtabs = 390,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 391,                /* -Wtarget-lifetime */
  OPT_Wtasks = 392,                          /* -Wtasks */
  OPT_Wtraditional = 393,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 394,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 395,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 396,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 397,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 398,                    /* -Wtype-limits */
  OPT_Wuncheck = 399,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 400,            /* -Wundeclared-selector */
  OPT_Wundef = 401,                          /* -Wundef */
  OPT_Wunderflow = 402,                      /* -Wunderflow */
  OPT_Wuninitialized = 403,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 404,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 405,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 406,              /* -Wunqualified-field */
  ...
  OPT_Wunused_argument = 411,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 412,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 413,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 414,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 415,                /* -Wunused-function */
  OPT_Wunused_import = 416,                  /* -Wunused-import */
  OPT_Wunused_label = 417,                   /* -Wunused-label */
  OPT_Wunused_local = 418,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 419,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 420,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 421,               /* -Wunused-parameter */
  OPT_Wunused_private = 422,                 /* -Wunused-private */
  OPT_Wunused_result = 423,                  /* -Wunused-result */
  OPT_Wunused_thrown = 424,                  /* -Wunused-thrown */
  ...
  OPT_Wuseless_type_check = 429,             /* -Wuseless-type-check */
  OPT_Wvarargs = 430,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 431,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 432,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 433,   /* -Wvector-operation-performance */
  OPT_Wvirtual_move_assign = 434,            /* -Wvirtual-move-assign */
  OPT_Wvla = 435,                            /* -Wvla */
  OPT_Wvolatile_register_var = 436,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 437,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 438,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 439,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 440,                       /* -Wzerotrip */
  OPT_Xassembler = 441,                      /* -Xassembler */
  OPT_Xlinker = 442,                         /* -Xlinker */
  OPT_Xpreprocessor = 443,                   /* -Xpreprocessor */
  OPT_Z = 444,                               /* -Z */
  OPT_ansi = 445,                            /* -ansi */
  OPT_aux_info = 446,                        /* -aux-info */
  /* OPT_aux_info_ = 447, */                 /* -aux-info= */
  OPT_auxbase = 448,                         /* -auxbase */
  OPT_auxbase_strip = 449,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 450, */             /* -bootclasspath */
  OPT_c = 451,                               /* -c */
  /* OPT_classpath = 452, */                 /* -classpath */
  OPT_coverage = 453,                        /* -coverage */
  OPT_cpp = 454,                             /* -cpp */
  OPT_cpp_ = 455,                            /* -cpp= */
  OPT_d = 456,                               /* -d */
  OPT_dumpbase = 457,                        /* -dumpbase */
  OPT_dumpdir = 458,                         /* -dumpdir */
  OPT_dumpmachine = 459,                     /* -dumpmachine */
  OPT_dumpspecs = 460,                       /* -dumpspecs */
  OPT_dumpversion = 461,                     /* -dumpversion */
  OPT_e = 462,                               /* -e */
  /* OPT_encoding = 463, */                  /* -encoding */
  OPT_export_dynamic = 464,                  /* -export-dynamic */
  OPT_extdirs = 465,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 466, */               /* -fCLASSPATH= */
  OPT_fPIC = 467,                            /* -fPIC */
  OPT_fPIE = 468,                            /* -fPIE */
  OPT_fRTS_ = 469,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 470,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 471,                   /* -fabi-version= */
  OPT_faccess_control = 472,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 473,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 474,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 475,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 476,                  /* -falign-commons */
  OPT_falign_functions = 477,                /* -falign-functions */
  OPT_falign_functions_ = 478,               /* -falign-functions= */
  OPT_falign_jumps = 479,                    /* -falign-jumps */
  OPT_falign_jumps_ = 480,                   /* -falign-jumps= */
  OPT_falign_labels = 481,                   /* -falign-labels */
  OPT_falign_labels_ = 482,                  /* -falign-labels= */
  OPT_falign_loops = 483,                    /* -falign-loops */
  OPT_falign_loops_ = 484,                   /* -falign-loops= */
  OPT_fall_intrinsics = 485,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 486, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 487,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 488,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 489, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 490, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 491, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 492, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 493, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 494,            /* -fasan-shadow-offset= */
  OPT_fasm = 495,                            /* -fasm */
  OPT_fassert = 496,                         /* -fassert */
  OPT_fassociative_math = 497,               /* -fassociative-math */
  OPT_fassume_compiled = 498,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 499,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 500,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 501,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 502,                   /* -fauto-profile */
  OPT_fauto_profile_ = 503,                  /* -fauto-profile= */
  OPT_fautomatic = 504,                      /* -fautomatic */
  OPT_faux_classpath = 505,                  /* -faux-classpath */
  OPT_fbackslash = 506,                      /* -fbackslash */
  OPT_fbacktrace = 507,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 508,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 509,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 510,              /* -fbootstrap-classes */
  OPT_fbounds_check = 511,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 512,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 513,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 514,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 515,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 516,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 517,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 518,                        /* -fbuiltin */
  OPT_fbuiltin_ = 519,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 520,                    /* -fcall-saved- */
  OPT_fcall_used_ = 521,                     /* -fcall-used- */
  OPT_fcaller_saves = 522,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 523,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 524,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 525,                /* -fcheck-data-deps */
  OPT_fcheck_new = 526,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 527,           /* -fcheck-pointer-bounds */
  OPT_fcheck_references = 528,               /* -fcheck-references */
  OPT_fcheck_ = 529,                         /* -fcheck= */
  OPT_fchkp_check_incomplete_type = 530,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 531,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 532,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 533,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_instrument_calls = 534,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 535,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 536,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 537, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 538,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 539,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 540,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 541, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 542,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 543,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 544,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 545,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 546,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 547,                       /* -fcilkplus */
  OPT_fclasspath_ = 548,                     /* -fclasspath= */
  OPT_fcoarray_ = 549,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 550,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 551,                         /* -fcommon */
  OPT_fcompare_debug = 552,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 553,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 554,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 555,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 556,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 557,                  /* -fcond-mismatch */
  OPT_fconserve_space = 558,                 /* -fconserve-space */
  OPT_fconserve_stack = 559,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 560,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 561,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 562,                       /* -fconvert= */
  OPT_fcprop_registers = 563,                /* -fcprop-registers */
  OPT_fcray_pointer = 564,                   /* -fcray-pointer */
  OPT_fcrossjumping = 565,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 566,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 567, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 568,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 569,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 570,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 571,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 572,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 573,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 574,                       /* -fdbg-cnt= */
  OPT_fdce = 575,                            /* -fdce */
  OPT_fdebug_cpp = 576,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 577,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 578,            /* -fdebug-types-section */
  ...
  OPT_fdiagnostics_show_caret = 594,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 595,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 596,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 597,                /* -fdirectives-only */
  OPT_fdisable_ = 598,                       /* -fdisable- */
  OPT_fdisable_assertions = 599,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 600,            /* -fdisable-assertions= */
  ...
  OPT_femit_class_file = 625,                /* -femit-class-file */
  OPT_femit_class_files = 626,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 627,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 628,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 629,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 630,                        /* -fenable- */
  OPT_fenable_assertions = 631,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 632,             /* -fenable-assertions= */
  OPT_fencoding_ = 633,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 634,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 635, */           /* -fenum-int-equiv */
  OPT_fexceptions = 636,                     /* -fexceptions */
  OPT_fexcess_precision_ = 637,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 638,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 639,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 640,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 641,                       /* -fextdirs= */
  OPT_fextended_identifiers = 642,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 643,                /* -fextern-tls-init */
  OPT_fexternal_blas = 644,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 645, */       /* -fexternal-templates */
  OPT_ff2c = 646,                            /* -ff2c */
  OPT_ffast_math = 647,                      /* -ffast-math */
  OPT_ffat_lto_objects = 648,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 649,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 650,               /* -ffinite-math-only */
  OPT_ffixed_ = 651,                         /* -ffixed- */
  OPT_ffixed_form = 652,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 653,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 654,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 655,                    /* -ffloat-store */
  OPT_ffor_scope = 656,                      /* -ffor-scope */
  /* OPT_fforce_addr = 657, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 658,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 659,              /* -fforward-propagate */
  OPT_ffp_contract_ = 660,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 661,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 662,                      /* -ffpe-trap= */
  OPT_ffree_form = 663,                      /* -ffree-form */
  OPT_ffree_line_length_ = 664,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 665,          /* -ffree-line-length-none */
  OPT_ffreestanding = 666,                   /* -ffreestanding */
  OPT_ffriend_injection = 667,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 668,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 669,                   /* -ffunction-cse */
  OPT_ffunction_sections = 670,              /* -ffunction-sections */
  OPT_fgcse = 671,                           /* -fgcse */
  OPT_fgcse_after_reload = 672,              /* -fgcse-after-reload */
  OPT_fgcse_las = 673,                       /* -fgcse-las */
  OPT_fgcse_lm = 674,                        /* -fgcse-lm */
  OPT_fgcse_sm = 675,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 676,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 677,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 678,                         /* -fgnu-tm */
  OPT_fgnu_unique = 679,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 680,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 681,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 682,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 683,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 684,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 685,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 686,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 687,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 688,                       /* -fgraphite */
  OPT_fgraphite_identity = 689,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 690,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 691, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 692, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 693,           /* -fhash-synchronization */
  /* OPT_fhelp = 694, */                     /* -fhelp */
  /* OPT_fhelp_ = 695, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 696,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 697, */                /* -fhonor-std */
  OPT_fhosted = 698,                         /* -fhosted */
  /* OPT_fhuge_objects = 699, */             /* -fhuge-objects */
  OPT_fident = 700,                          /* -fident */
  OPT_fif_conversion = 701,                  /* -fif-conversion */
  OPT_fif_conversion2 = 702,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 703,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 704,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 705,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 706,             /* -fimplicit-templates */
  OPT_findirect_classes = 707,               /* -findirect-classes */
  OPT_findirect_dispatch = 708,              /* -findirect-dispatch */
  OPT_findirect_inlining = 709,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 710,         /* -finhibit-size-directive */
  OPT_finit_character_ = 711,                /* -finit-character= */
  OPT_finit_integer_ = 712,                  /* -finit-integer= */
  OPT_finit_local_zero = 713,                /* -finit-local-zero */
  OPT_finit_logical_ = 714,                  /* -finit-logical= */
  OPT_finit_real_ = 715,                     /* -finit-real= */
  OPT_finline = 716,                         /* -finline */
  OPT_finline_atomics = 717,                 /* -finline-atomics */
  OPT_finline_functions = 718,               /* -finline-functions */
  OPT_finline_functions_called_once = 719,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 720, */            /* -finline-limit- */
  OPT_finline_limit_ = 721,                  /* -finline-limit= */
  OPT_finline_small_functions = 722,         /* -finline-small-functions */
  OPT_finput_charset_ = 723,                 /* -finput-charset= */
  OPT_finstrument_functions = 724,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 725,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 726,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 727,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 728,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 729,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 730,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 731,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 732,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 733,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 734,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 735,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 736, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 737,                    /* -fipa-profile */
  OPT_fipa_pta = 738,                        /* -fipa-pta */
  OPT_fipa_pure_const = 739,                 /* -fipa-pure-const */
  OPT_fipa_ra = 740,                         /* -fipa-ra */
  OPT_fipa_reference = 741,                  /* -fipa-reference */
  OPT_fipa_sra = 742,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 743, */         /* -fipa-struct-reorg */
  ...
  OPT_m128bit_long_double = 1137,            /* -m128bit-long-double */
  OPT_m16 = 1138,                            /* -m16 */
  OPT_m32 = 1139,                            /* -m32 */
  OPT_m3dnow = 1140,                         /* -m3dnow */
  OPT_m3dnowa = 1141,                        /* -m3dnowa */
  OPT_m64 = 1142,                            /* -m64 */
  OPT_m80387 = 1143,                         /* -m80387 */
  OPT_m8bit_idiv = 1144,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1145,             /* -m96bit-long-double */
  OPT_mabi_ = 1146,                          /* -mabi= */
  OPT_mabm = 1147,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1148,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1149,                 /* -maddress-mode= */
  OPT_madx = 1150,                           /* -madx */
  OPT_maes = 1151,                           /* -maes */
  OPT_malign_data_ = 1152,                   /* -malign-data= */
  OPT_malign_double = 1153,                  /* -malign-double */
  OPT_malign_functions_ = 1154,              /* -malign-functions= */
  OPT_malign_jumps_ = 1155,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1156,                  /* -malign-loops= */
  OPT_malign_stringops = 1157,               /* -malign-stringops */
  OPT_mandroid = 1158,                       /* -mandroid */
  OPT_march_ = 1159,                         /* -march= */
  OPT_masm_ = 1160,                          /* -masm= */
  OPT_mavx = 1161,                           /* -mavx */
  OPT_mavx2 = 1162,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1163,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1164,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1165,                      /* -mavx512bw */
  OPT_mavx512cd = 1166,                      /* -mavx512cd */
  OPT_mavx512dq = 1167,                      /* -mavx512dq */
  OPT_mavx512er = 1168,                      /* -mavx512er */
  OPT_mavx512f = 1169,                       /* -mavx512f */
  OPT_mavx512ifma = 1170,                    /* -mavx512ifma */
  OPT_mavx512pf = 1171,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1172,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1173,                      /* -mavx512vl */
  OPT_mbionic = 1174,                        /* -mbionic */
  OPT_mbmi = 1175,                           /* -mbmi */
  OPT_mbmi2 = 1176,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1177,                  /* -mbranch-cost= */
  OPT_mcld = 1178,                           /* -mcld */
  OPT_mclflushopt = 1179,                    /* -mclflushopt */
  OPT_mclwb = 1180,                          /* -mclwb */
  OPT_mcmodel_ = 1181,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1182, */                    /* -mcpu= */
  OPT_mcrc32 = 1183,                         /* -mcrc32 */
  OPT_mcx16 = 1184,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1185,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1186,            /* -mdump-tune-features */
  OPT_mf16c = 1187,                          /* -mf16c */
  OPT_mfancy_math_387 = 1188,                /* -mfancy-math-387 */
  OPT_mfentry = 1189,                        /* -mfentry */
  OPT_mfma = 1190,                           /* -mfma */
  OPT_mfma4 = 1191,                          /* -mfma4 */
  OPT_mforce_drap = 1192,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1193,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1194,                       /* -mfpmath= */
  OPT_mfsgsbase = 1195,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1196, */              /* -mfused-madd */
  OPT_mfxsr = 1197,                          /* -mfxsr */
  OPT_mglibc = 1198,                         /* -mglibc */
  OPT_mhard_float = 1199,                    /* -mhard-float */
  OPT_mhle = 1200,                           /* -mhle */
  OPT_mieee_fp = 1201,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1202,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1203,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1204,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1205, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1206,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1207,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1208,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1209,                /* -mlong-double-80 */
  OPT_mlwp = 1210,                           /* -mlwp */
  OPT_mlzcnt = 1211,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1212,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1213,              /* -mmemset-strategy= */
  OPT_mmmx = 1214,                           /* -mmmx */
  OPT_mmovbe = 1215,                         /* -mmovbe */
  OPT_mmpx = 1216,                           /* -mmpx */
  OPT_mms_bitfields = 1217,                  /* -mms-bitfields */
  OPT_mmusl = 1218,                          /* -mmusl */
  OPT_mmwaitx = 1219,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1220,            /* -mno-align-stringops */
  OPT_mno_default = 1221,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1222,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1223,                  /* -mno-push-args */
  OPT_mno_red_zone = 1224,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1225,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1226,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1227,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1228,                          /* -mpc32 */
  OPT_mpc64 = 1229,                          /* -mpc64 */
  OPT_mpc80 = 1230,                          /* -mpc80 */
  OPT_mpclmul = 1231,                        /* -mpclmul */
  OPT_mpcommit = 1232,                       /* -mpcommit */
  OPT_mpopcnt = 1233,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1234,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1235,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1236,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1237,                        /* -mprfchw */
  OPT_mpush_args = 1238,                     /* -mpush-args */
  OPT_mrdrnd = 1239,                         /* -mrdrnd */
  OPT_mrdseed = 1240,                        /* -mrdseed */
  OPT_mrecip = 1241,                         /* -mrecip */
  OPT_mrecip_ = 1242,                        /* -mrecip= */
  OPT_mrecord_mcount = 1243,                 /* -mrecord-mcount */
  OPT_mred_zone = 1244,                      /* -mred-zone */
  OPT_mregparm_ = 1245,                      /* -mregparm= */
  OPT_mrtd = 1246,                           /* -mrtd */
  OPT_mrtm = 1247,                           /* -mrtm */
  OPT_msahf = 1248,                          /* -msahf */
  OPT_msha = 1249,                           /* -msha */
  OPT_mskip_rax_setup = 1250,                /* -mskip-rax-setup */
  OPT_msoft_float = 1251,                    /* -msoft-float */
  OPT_msse = 1252,                           /* -msse */
  OPT_msse2 = 1253,                          /* -msse2 */
  OPT_msse2avx = 1254,                       /* -msse2avx */
  OPT_msse3 = 1255,                          /* -msse3 */
  OPT_msse4 = 1256,                          /* -msse4 */
  OPT_msse4_1 = 1257,                        /* -msse4.1 */
  OPT_msse4_2 = 1258,                        /* -msse4.2 */
  OPT_msse4a = 1259,                         /* -msse4a */
  /* OPT_msse5 = 1260, */                    /* -msse5 */
  OPT_msseregparm = 1261,                    /* -msseregparm */
  OPT_mssse3 = 1262,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1263,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1264,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1265,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1266,            /* -mstringop-strategy= */
  OPT_mtbm = 1267,                           /* -mtbm */
  OPT_mtls_dialect_ = 1268,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1269,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1270,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1271,                         /* -mtune= */
  OPT_muclibc = 1272,                        /* -muclibc */
  OPT_mveclibabi_ = 1273,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1274,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1275,                    /* -mvzeroupper */
  OPT_mx32 = 1276,                           /* -mx32 */
  OPT_mxop = 1277,                           /* -mxop */
  OPT_mxsave = 1278,                         /* -mxsave */
  OPT_mxsavec = 1279,                        /* -mxsavec */
  OPT_mxsaveopt = 1280,                      /* -mxsaveopt */
  OPT_mxsaves = 1281,                        /* -mxsaves */
  OPT_n = 1282,                              /* -n */
  OPT_no_canonical_prefixes = 1283,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1284,              /* -no-integrated-cpp */
  OPT_nocpp = 1285,                          /* -nocpp */
  OPT_nodefaultlibs = 1286,                  /* -nodefaultlibs */
  OPT_nopie = 1287,                          /* -nopie */
  OPT_nostartfiles = 1288,                   /* -nostartfiles */
  OPT_nostdinc = 1289,                       /* -nostdinc */
  OPT_nostdinc__ = 1290,                     /* -nostdinc++ */
  OPT_nostdlib = 1291,                       /* -nostdlib */
  OPT_o = 1292,                              /* -o */
  OPT_p = 1293,                              /* -p */
  OPT_pass_exit_codes = 1294,                /* -pass-exit-codes */
  /* OPT_pedantic = 1295, */                 /* -pedantic */
  OPT_pedantic_errors = 1296,                /* -pedantic-errors */
  OPT_pg = 1297,                             /* -pg */
  OPT_pie = 1298,                            /* -pie */
  OPT_pipe = 1299,                           /* -pipe */
  OPT_posix = 1300,                          /* -posix */
  OPT_print_file_name_ = 1301,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1302,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1303,          /* -print-multi-directory */
  OPT_print_multi_lib = 1304,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1305,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1306,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1307,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1308,               /* -print-prog-name= */
  OPT_print_search_dirs = 1309,              /* -print-search-dirs */
  OPT_print_sysroot = 1310,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1311,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1312,                        /* -profile */
  OPT_pthread = 1313,                        /* -pthread */
  OPT_quiet = 1314,                          /* -quiet */
  OPT_r = 1315,                              /* -r */
  OPT_rdynamic = 1316,                       /* -rdynamic */
  OPT_remap = 1317,                          /* -remap */
  OPT_s = 1318,                              /* -s */
  OPT_s_bc_abi = 1319,                       /* -s-bc-abi */
  OPT_save_temps = 1320,                     /* -save-temps */
  OPT_save_temps_ = 1321,                    /* -save-temps= */
  OPT_shared = 1322,                         /* -shared */
  OPT_shared_libgcc = 1323,                  /* -shared-libgcc */
  /* OPT_specs = 1324, */                    /* -specs */
  OPT_specs_ = 1325,                         /* -specs= */
  OPT_static = 1326,                         /* -static */
  OPT_static_libasan = 1327,                 /* -static-libasan */
  OPT_static_libgcc = 1328,                  /* -static-libgcc */
  OPT_static_libgcj = 1329,                  /* -static-libgcj */
  OPT_static_libgfortran = 1330,             /* -static-libgfortran */
  OPT_static_libgo = 1331,                   /* -static-libgo */
  OPT_static_liblsan = 1332,                 /* -static-liblsan */
  OPT_static_libmpx = 1333,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1334,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1335,               /* -static-libstdc++ */
  OPT_static_libtsan = 1336,                 /* -static-libtsan */
  OPT_static_libubsan = 1337,                /* -static-libubsan */
  /* OPT_std_c__03 = 1338, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1339, */                /* -std=c++0x */
  OPT_std_c__11 = 1340,                      /* -std=c++11 */
  OPT_std_c__14 = 1341,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1342, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1343, */                /* -std=c++1y */
  OPT_std_c__1z = 1344,                      /* -std=c++1z */
  OPT_std_c__98 = 1345,                      /* -std=c++98 */
  OPT_std_c11 = 1346,                        /* -std=c11 */
  /* OPT_std_c1x = 1347, */                  /* -std=c1x */
  /* OPT_std_c89 = 1348, */                  /* -std=c89 */
  OPT_std_c90 = 1349,                        /* -std=c90 */
  OPT_std_c99 = 1350,                        /* -std=c99 */
  /* OPT_std_c9x = 1351, */                  /* -std=c9x */
  OPT_std_f2003 = 1352,                      /* -std=f2003 */
  OPT_std_f2008 = 1353,                      /* -std=f2008 */
  OPT_std_f2008ts = 1354,                    /* -std=f2008ts */
  OPT_std_f95 = 1355,                        /* -std=f95 */
  OPT_std_gnu = 1356,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1357, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1358, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1359,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1360,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1361, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1362, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1363,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1364,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1365,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1366, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1367, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1368,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1369,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1370, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1371, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1372,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1373, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1374, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1375, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1376,                     /* -std=legacy */
  OPT_symbolic = 1377,                       /* -symbolic */
  OPT_t = 1378,                              /* -t */
  OPT_time = 1379,                           /* -time */
  OPT_time_ = 1380,                          /* -time= */
  OPT_tno_android_cc = 1381,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1382,                 /* -tno-android-ld */
  OPT_traditional = 1383,                    /* -traditional */
  OPT_traditional_cpp = 1384,                /* -traditional-cpp */
  OPT_trigraphs = 1385,                      /* -trigraphs */
  OPT_u = 1386,                              /* -u */
  OPT_undef = 1387,                          /* -undef */
  OPT_v = 1388,                              /* -v */
  OPT_version = 1389,                        /* -version */
  OPT_w = 1390,                              /* -w */
  OPT_wrapper = 1391,                        /* -wrapper */
  OPT_x = 1392,                              /* -x */
  OPT_z = 1393,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
